...
//   4. pause blocks both deposits and deductions; unpause restores them.
        ...
        for _ in 0..steps {
            ...
            match op {
                ...
                0 => {
                    ...
                    if usdc_client.balance(&owner) < amount {
                    ...
                    if paused {
                        ...
                        match sim.checked_add(amount) {
                            Some(v) => {
                                sim = v;
                                client.deposit(&owner, &amount);
                            }
                            None => {
                                // deposit must fail on overflow
                                assert!(client.try_deposit(&owner, &amount).is_err());
                            }
                        }
                    }
